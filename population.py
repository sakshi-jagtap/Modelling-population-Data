...
class PopulationTree(AbstractTree):
    ...
    def get_separator(self) -> str:
        ...
        return self._parent_tree.get_separator() + '/' + str(self._root)
    ...
    for region in regions:
        ...
        for country in country_populations:
            if country in regions[region]:
                population = PopulationTree(False, country.strip(),
                                            [], country_populations[country])
                left_tree += [population]
        right_tree = PopulationTree(False, region.strip(), left_tree)
        lst += [right_tree]
    return lst
